...
mod test {
    ...
    #[tokio::test]
    async fn buffer_buffers_less_from_given_n() {
    ...
    #[tokio::test]
    async fn buffer_buffers_as_big_as_given_n() {
        let (input_sender, input_receiver) = mpsc::channel(100);
    ...
    #[tokio::test]
    async fn buffer_buffers_n_inputs_while_not_consumed() {
