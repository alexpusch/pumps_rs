    ...
    Out: Send + 'static,
{
    ...
    /// When a downstream operation slows down, backpressure will allow some items to occumulate, tempreraly preventing upstream blocking.
    pub fn backpressure(self, n: usize) -> Pipeline<Out> {
        self.pump(crate::pumps::backpressure::Buffer { n })
    }
    ...
    /// When a downstream operation slows down, backpressure with relief valve will allow recent items to occumulate, preventing upstream blocking
